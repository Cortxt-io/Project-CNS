...
# /org-underhall — håll bemanningsunderlaget aktuellt
...
## Triggers
1. **Vid behov:** när nya departments/roller läggs i manifest eller aktiveras via `/bemanna`.
...
2. **Granska bemanna-pelarna** (`.claude/skills/bemanna/SKILL.md`): stämmer de fyra pelarna och
...
## Gräns
- Du formar underlaget (matris/pelare/kriterier); @hr-chef bemannar enskilda roller via `/bemanna`.
