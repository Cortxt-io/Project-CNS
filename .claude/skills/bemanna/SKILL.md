...
# /bemanna — rigorös agent-onboarding
...
**Gräns:** @hr-chef äger behovet + verktygen, @kompetensutvecklare promptkvaliteten,
@org-arkitekt att strukturen stämmer. Mekaniken: `scripts/bemanna.py` (grindad av
...
- Saknas cellen (ny dept/nivå)? Kör `/org-underhall` (org-arkitekt) som lägger den först.
...
## Pelare 1 — Systemprompt-design (@hr-chef + @kompetensutvecklare)
