...
status: roster
description: Frontend-utvecklare i avdelningen Engineering/Frontend. (Skal — fyll vid bemanning.)
---
...
- Hör till: Engineering → Frontend (chapter: Frontend)
