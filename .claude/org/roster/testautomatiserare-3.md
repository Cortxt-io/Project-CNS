---
name: testautomatiserare-3
title: Testautomatiserare
...
status: roster
description: Testautomatiserare i avdelningen Engineering/QA. (Skal — fyll vid bemanning.)
---
...
- Hör till: Engineering → QA (chapter: QA)
