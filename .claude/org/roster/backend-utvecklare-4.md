...
status: roster
description: Backend-utvecklare i avdelningen Engineering/Backend. (Skal — fyll vid bemanning.)
---
...
- Hör till: Engineering → Backend (chapter: Backend)
